...
# Define cleanup function to execute the curl command
cleanup() {
	echo "Container is shutting down. Saving S3 state..."
	curl -X POST http://localhost:4566/_localstack/state/s3/save || echo "Failed to save S3 state."
